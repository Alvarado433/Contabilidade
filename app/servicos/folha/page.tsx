...
export default function FolhaPage() {
    return (
        <>
            ...
            <main>
                <BannerFolhaInterno
                    titulo={folhaData.folhaPagamento.titulo}
                    descricao={folhaData.folhaPagamento.descricao}
                    icone={folhaData.folhaPagamento.icone}
                    gradiente={folhaData.folhaPagamento.estilo.gradiente}
                />
            </main>
